 ...
 * Get client talents.
 *
 * @headers Authorization auth_token (stored in store/authToken by a previous md call - signin)
 *
 * Makes a GET request to the MF Integration API sending the client authentication token and
 * returns the talent list.
 *
 *
 */
